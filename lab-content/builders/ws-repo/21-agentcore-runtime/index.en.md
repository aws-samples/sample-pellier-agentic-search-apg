---
title: "Act II · Platform — AgentCore Runtime (Demo)"
weight: 21
---

:::alert{type="info"}
**Act II · Platform + operator view.** About five minutes. Bootstrap
already ran `agentcore configure` and `agentcore launch` before you
arrived. In-room you read the entrypoint and **invoke** the managed
...
[Act II · Routing patterns →](/30-routing-patterns/)
