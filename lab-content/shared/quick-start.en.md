...
```bash
rebuild-frontend       # Builds the SPA + restarts the service
```

You only need this if you edit files in `pellier/frontend/src/`. Python changes are picked up automatically by `--reload`.
